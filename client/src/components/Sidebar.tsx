    ...
    <AnimatePresence>
      {sidebarOpen && session && (
        ...
        >
          ...
          >
            <div className="absolute inset-y-0 left-0 w-0.5 bg-border group-hover:bg-zinc-500 transition-colors" />
          </div>
